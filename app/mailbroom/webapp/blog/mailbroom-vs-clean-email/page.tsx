...
const faqs = [
  {
    ...
    a: "For bulk organizing and unsubscribing, yes — the core cleanup mechanics are comparable. The difference is who each is built for: Clean Email's pricing is structured around buying a bundle of accounts (1, 5, or 10) to share with people you know personally, like family. MailBroom is licensed once per organization, with every employee on the company's Microsoft domain getting automatic access via Microsoft SSO — no shared logins, no per-person account purchase.",
  },
  {
    q: "Does Clean Email support shared or delegated Microsoft 365 mailboxes?",
    a: "We found no published documentation on shared or delegated mailbox support for Clean Email. MailBroom explicitly supports this — an admin can enable access to a shared mailbox like info@ or sales@, or a colleague's delegated mailbox, the same way as a personal one, once that's turned on for the organization.",
  },
  {
    q: "What does Clean Email cost for a whole company?",
    a: "Clean Email doesn't publish per-organization pricing on its own site — its plans page is structured around personal account bundles, with a 'contact us for a quote' path for bulk/organizational needs. Independent review site TheBusinessDive lists Clean Email's account-bundle pricing at roughly €11.99/month for 1 account, €23.99/month for 5, and €35.99/month for 10, with monthly billing — and that same review scores its team/collaboration fit just 1 out of 5, noting it 'was designed for individuals, not teams.' MailBroom publishes flat monthly pricing by seat band (1–5, 6–10, 11–25, 26–50, 51–100 seats) built specifically for company-wide use, with custom quoting only above 100 seats.",
  },
  {
    q: "Does Clean Email work with more email providers than MailBroom?",
    a: "Yes, and this is a genuine Clean Email advantage if it matters to your organization: it connects to Gmail, Yahoo, AOL, and other providers, not just Microsoft 365. MailBroom for Business is built specifically for Microsoft 365 and Exchange Online — that focus is what lets it plug directly into Microsoft Graph API and Entra ID for one-click company-wide SSO deployment, rather than juggling credentials across providers.",
  },
];
    ...
    <div className="min-h-screen hero-gradient grid-bg">
      ...
      <section className="max-w-3xl mx-auto px-6 pb-16 space-y-8">
        ...
        <div className="card-glass rounded-2xl p-8 space-y-5 text-mist leading-relaxed">
          <p>
            Clean Email is a real, well-established tool for bulk-organizing and unsubscribing from unwanted email, and it genuinely competes with MailBroom on the mechanics of cleanup. If you&apos;re an IT admin comparing the two for a company running Microsoft 365, though, the honest answer is: they&apos;re built for different buyers.
          </p>
          <p>
            <strong className="text-cloud">Clean Email is built around personal account bundles — buy access for 1, 5, or 10 accounts and share it with people you know, like family.</strong> MailBroom for Business is licensed once per organization, with every employee on the company&apos;s Microsoft domain getting access automatically through Microsoft SSO. That single difference shapes almost everything else about how each tool fits — or doesn&apos;t — into a company&apos;s Microsoft 365 tenant.
          </p>
        </div>
        ...
        <div className="card-glass rounded-2xl p-8 space-y-5">
          ...
          <p className="text-mist leading-relaxed">
            Clean Email&apos;s own pricing page frames its multi-account plans around sharing with people you know personally — buy 5 or 10 accounts and share them with friends and family. It does support company/business use, with employees at thousands of companies among its users, but the published buying model is account bundles, not an organization-wide license.
          </p>
          <p className="text-mist leading-relaxed">
            MailBroom for Business is licensed per organization, not per person. An IT admin subscribes once, signs in via Microsoft SSO, and every employee with a matching company email address gets automatic access — no invite list, no separate account for each person to manage, no shared credentials.
          </p>
        </div>
        ...
        <div className="card-glass rounded-2xl p-8 space-y-5">
          ...
          <p className="text-mist leading-relaxed">
            MailBroom for Business connects via Microsoft Entra ID sign-in (Microsoft SSO) and the Microsoft Graph API. It never sees or stores a password — it receives a scoped, revocable access token limited to exactly what mailbox cleanup requires, and an org admin can revoke that access instantly from the organization&apos;s own Microsoft admin settings, independent of MailBroom entirely.
          </p>
          <p className="text-mist leading-relaxed">
            ...
            <table className="w-full text-sm text-left border-collapse">
              ...
              <tbody className="text-mist">
                {[
                  ...
                  ["Storage cleanup by age or domain", "✓", "Partial — organizing focus, not storage-targeted"],
