...
export const alt = "MailBroom for Business";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        />
        <div style={{ display: "flex", fontSize: 64, fontWeight: 800, color: "#E2E8F0", letterSpacing: "-0.02em" }}>
          MailBroom&nbsp;<span style={{ color: "#FBBF24" }}>for Business</span>
        </div>
        <div style={{ display: "flex", fontSize: 28, color: "#94A3B8", marginTop: 20 }}>
