// Icons for the contact rows on the public card page, drawn in white on each
// row's coloured tile. Brand marks are from simple-icons v16.32.0 (CC0) and
// phone/mail/globe from lucide-static v1.48.0 (ISC), inlined rather than
// added as dependencies. simple-icons dropped LinkedIn at LinkedIn's request,
// so that one is drawn as its "in" wordmark instead.
const BRAND_PATHS = {
