...
export const IOS_ROUTES = [
  ...
  { path: "/blog/mailbroom-vs-unroll-me", priority: 0.6, changeFrequency: "monthly" },
  { path: "/blog/clean-up-promotional-emails-without-third-party-access", priority: 0.6, changeFrequency: "monthly" },
  { path: "/blog/gmail-storage-full", priority: 0.6, changeFrequency: "monthly" },
];
